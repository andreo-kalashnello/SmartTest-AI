...
- [ ] **v1-test** Первая миграция, seed опционально (один демо-пользователь)
...
- [ ] **v1-test** Провайдер(ы) по выбору (credentials / OAuth) — достаточно одного способа для демо
...
- [ ] **v1-test** *Опционально для v1:* если live не входит в демо — отложить; иначе минимум одно событие «подключился ученик»
...
- [ ] **v1-test** *Если AI в демо:* один эндпоинт «сгенерировать N вопросов по теме» с жёстким лимитом токенов; иначе пропустить до июня
